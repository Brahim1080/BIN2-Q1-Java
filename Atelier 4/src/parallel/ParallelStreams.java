...
public class ParallelStreams {
    ...
    private static long serialFilteredBefore() {
        ...
        return runAndRecordTime(() -> {
            ...
            System.out.println(numbers.stream().filter(a -> a % 2 == 0).map(DelayedOperations::ultraSlowMult2).toList());
    ...
    private static long serialFilteredAfter() {
        ...
        return runAndRecordTime(() -> {
            System.out.println(numbers.stream().map(DelayedOperations::ultraSlowMult2).filter(a -> a % 4 == 0).toList());
    ...
    private static long parallelFilteredBefore() {
        ...
        return runAndRecordTime(()->{
            System.out.println(numbers.stream().parallel().filter(a -> a % 2 == 0).map(DelayedOperations::ultraSlowMult2).toList());
    ...
    private static long parallelFilteredAfter() {
        ...
        return runAndRecordTime(()->{
            System.out.println(numbers.stream().parallel().map(DelayedOperations::ultraSlowMult2).filter(a -> a % 4 == 0).toList());
        });
    }
    ...
    private static long randomMap() {
        ...
        return runAndRecordTime(()-> System.out.println(numbers.stream().parallel().map(DelayedOperations::randomlySlowMult2).toList()));
    }
}
