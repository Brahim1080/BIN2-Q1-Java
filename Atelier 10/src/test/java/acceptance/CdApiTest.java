...
public class CdApiTest {
    private CatalogImpl defaultCatalog;
    private DomainFactory factory = new DomainFactory();

    @BeforeEach
    void setUp() {
        defaultCatalog = new CatalogImpl();
        CompactDisc cd1 = factory.createCompactDisc("Young Mystic", "Bob Marley", 3, 12,
                "666-777");
        CompactDisc cd2 = factory.createCompactDisc("Time Out", "Dave Brubeck Quartet", 10,
                111.1, "123-456");
