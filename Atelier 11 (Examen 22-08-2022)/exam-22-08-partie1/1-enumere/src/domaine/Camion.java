...
public class Camion  {
    ...
    public enum Gabarit{
        DEUX_ESSIEUX(20,16400), TROIS_ESSIEUX(30,22000),
        QUATRE_ESSIEUX(40,28600);

        private int  nbMaxCaisses , chargeMaximal;

        Gabarit(int nbMaxCaisses, int chargeMaximal) {
        ...
        public int getChargeMaximal() {
            return chargeMaximal;
        }

        @Override
        public String toString() {
            return "nbMaxCaisses=" + nbMaxCaisses +
                            " chargeMaximal=" + chargeMaximal ;
        }
    }
    ...
    public boolean ajouterTrajet(Trajet trajet){
        ...
        if (this.gabarit.getChargeMaximal() < trajet.calculerPoidsTotal()) return false;
    ...
    private Trajet rechercherTrajet(Caisse caisse) {
        ...
        for (Trajet trajetPrevu : trajets){
            if (trajetPrevu.peutAjouter(caisse)
                ...
                && trajetPrevu.calculerPoidsTotal() + caisse.getPoids() <= gabarit.getChargeMaximal()) {
